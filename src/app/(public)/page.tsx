  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      >
        ...
        {/* Tekst i CTA – górna część (nad wzgórzami, na tle nieba) */}
        <div className="w-full flex flex-col items-center pt-32 pb-10 px-6">
          ...
          {/* Nagłówek – ciemny, nad jasnym niebem */}
          <h1 className="text-center text-5xl md:text-6xl lg:text-7xl text-gray-900 leading-[1.1] tracking-tight max-w-4xl" style={{ fontFamily: 'var(--font-playfair)', fontWeight: 400 }}>
            Sprawdź działkę zanim{' '}
            <span style={{ fontWeight: 700 }}>zainwestujesz.</span>
          </h1>

          <p className="mt-5 text-center text-lg md:text-xl text-gray-600 max-w-xl leading-relaxed" style={{ fontFamily: 'var(--font-playfair)' }}>
        ...
        {/* Floating mockup – siedzi nad zielonymi wzgórzami */}
        <div className="w-full max-w-4xl px-6 relative">
          {/* gradient zanikania na dole – "podgląd" */}
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden" style={{ maxHeight: '500px', overflow: 'hidden' }}>
            ...
            {/* Treść raportu — wierna kopia prawdziwego raportu */}
            <div className="p-5 bg-white" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>

              {/* Header */}
              <div className="flex items-start justify-between mb-4 pb-3 border-b border-gray-100">
                <div>
                  <p className="text-xs font-semibold text-green-700 mb-1" style={{ fontFamily: 'var(--font-playfair)' }}>SprawdzDziałkę.pl</p>
                  <h2 className="text-base font-semibold text-gray-900 leading-tight" style={{ fontFamily: 'var(--font-playfair)' }}>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                ...
                <div className="border border-gray-100 rounded-xl p-3">
                  <div className="flex items-center gap-1.5 mb-2.5 pb-2 border-b border-gray-100">
                    ...
                    <span className="font-semibold text-gray-800" style={{ fontFamily: 'var(--font-playfair)' }}>Dane podstawowe</span>
                  </div>
                ...
                <div className="border border-gray-100 rounded-xl p-3">
                  <div className="flex items-center gap-1.5 mb-2.5 pb-2 border-b border-gray-100">
                    <span className="w-5 h-5 bg-green-50 rounded-md flex items-center justify-center text-xs">⚡</span>
                    <span className="font-semibold text-gray-800" style={{ fontFamily: 'var(--font-playfair)' }}>Media i uzbrojenie</span>
                  </div>
                ...
                <div className="border border-gray-100 rounded-xl p-3">
                  <div className="flex items-center gap-1.5 mb-2.5 pb-2 border-b border-gray-100">
                    <span className="w-5 h-5 bg-green-50 rounded-md flex items-center justify-center text-xs">📋</span>
                    <span className="font-semibold text-gray-800" style={{ fontFamily: 'var(--font-playfair)' }}>Plan zagospodarowania</span>
                  </div>
                  {[['Symbol terenu','MN – zabudowa mieszkaniowa'],['Wysokość max','9 m (2 kondygnacje)'],['Min. pow. biol. czynna','30%'],['Typ dachu','dwuspadowy, stromizna 35–45°'],['Źródło','Uchwała MPZP nr XXI/143/2023']].map(([k,v]) => (
                    <div key={k} className="flex justify-between py-1 border-b border-gray-50 last:border-0">
                      <span className="text-gray-400">{k}</span>
                ...
                <div className="border border-gray-100 rounded-xl p-3">
                  <div className="flex items-center gap-1.5 mb-2.5 pb-2 border-b border-gray-100">
                    <span className="w-5 h-5 bg-green-50 rounded-md flex items-center justify-center text-xs">🛡</span>
                    <span className="font-semibold text-gray-800" style={{ fontFamily: 'var(--font-playfair)' }}>Strefy i ograniczenia</span>
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <div className="flex gap-1.5 bg-amber-50 rounded-lg px-2 py-1.5 leading-snug">
                      ...
                      <span className="text-amber-800">Natura 2000 (OSO): Grądy Odrzańskie; (SOO): Grądy w Dolinie Odry</span>
                    </div>
                    <div className="flex gap-1.5 bg-green-50 rounded-lg px-2 py-1.5 leading-snug">
                      <span className="text-green-600 flex-shrink-0">✅</span>
                ...
                <div className="col-span-2 border border-gray-100 rounded-xl p-3">
                  <div className="flex items-center gap-1.5 mb-2.5 pb-2 border-b border-gray-100">
                    <span className="w-5 h-5 bg-green-50 rounded-md flex items-center justify-center text-xs">✨</span>
                    <span className="font-semibold text-gray-800" style={{ fontFamily: 'var(--font-playfair)' }}>Rekomendacje AI</span>
                  </div>
        ...
        {/* Social proof – nad ciemnymi wzgórzami, wewnątrz hero */}
          ...
          {[
            {
              ...
              title: 'MPZP i zabudowa',
              desc: 'Przeznaczenie terenu, max wysokość, PBC — prosto z aktualnej uchwały gminy.',
            },
            {
              icon: <Shield className="w-6 h-6" />,
              color: 'bg-blue-50 text-blue-600',
              title: 'Strefy i ochrona',
              desc: 'Natura 2000, parki krajobrazowe, strefy zalewowe ISOK — auto wykrywane.',
            },
            {
              icon: <Zap className="w-6 h-6" />,
              color: 'bg-amber-50 text-amber-600',
              title: 'Media i uzbrojenie',
              desc: 'Woda, kanalizacja, gaz, prąd. Dane z SIP gminy lub OpenStreetMap.',
            },
            {
              icon: <FileText className="w-6 h-6" />,
              color: 'bg-purple-50 text-purple-600',
              title: 'Rekomendacje AI',
              desc: 'Claude AI analizuje dane i wskazuje ryzyka inwestycyjne specyficzne dla działki.',
            },
          ].map(f => (
            <div
              key={f.title}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={s.step} className="text-center">
                <div className="w-14 h-14 rounded-2xl bg-green-600 text-white font-bold text-xl flex items-center justify-center mx-auto mb-4">
                  {s.step}
                </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="border border-gray-200 rounded-2xl p-8">
            ...
            <Link href="/register" className="block text-center border border-gray-300 text-gray-700 font-medium py-3 rounded-xl hover:bg-gray-50 transition-colors">
              Zacznij za darmo
            </Link>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-8 text-white relative overflow-hidden">
            ...
            <Link href="/register" className="block text-center bg-green-600 hover:bg-green-500 text-white font-semibold py-3 rounded-xl transition-colors">
      ...
      <section className="relative overflow-hidden bg-gray-900 py-24 text-center">
        <div
          ...
          style={{ background: 'radial-gradient(ellipse at 50% 0%, #16a34a, transparent 70%)' }}
        />
